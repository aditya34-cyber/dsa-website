...
const Index = () => {
  ...
  const handleTopicClick = (topicTitle: string) => {
    if (topicTitle === "Sorting Algorithms") {
      navigate("/sorting");
    } else if (topicTitle === "Searching Algorithms") {
      navigate("/searching");
    } else if (topicTitle === "Stacks") {
      navigate("/stacks");
    } else if (topicTitle === "Queues") {
      navigate("/queues");
    } else if (topicTitle === "Coding Practice") {
      navigate("/coding-practice");
    } else {
      toast({
        title: `${topicTitle} Coming Soon!`,
        description: "This feature is currently under development. Stay tuned for interactive visualizations!",
      });
    }
  };
        ...
        <div className="space-y-6">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Master the fundamentals with our interactive visualizations. Each topic includes theory, 
              practice problems, and real-time algorithm execution.
            </p>
          </div>
